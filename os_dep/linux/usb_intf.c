...
static struct usb_device_id rtw_usb_id_tbl[] = {
	...
	/* TP-link devices - based on:
	 * https://github.com/lwfinger/rtw8852cu/issues/17#issuecomment-2196029089
	 * https://github.com/lwfinger/rtw8852cu/issues/20#issue-2439643815 */
	{USB_DEVICE_AND_INTERFACE_INFO(0x35b2, 0x0502, 0xff, 0xff, 0xff), .driver_info = RTL8852C}, /* TP-Link AXE5400 (RTW8832CU) */
	{USB_DEVICE_AND_INTERFACE_INFO(0x35b2, 0x0102, 0xff, 0xff, 0xff), .driver_info = RTL8852C}, /* TP-Link AXE5400 (RTW8852CU) */
	{USB_DEVICE_AND_INTERFACE_INFO(0x35bc, 0x0101, 0xff, 0xff, 0xff), .driver_info = RTL8852C}, /* TP-Link Archer TX50UH (RTW8852CU) */
	{USB_DEVICE_AND_INTERFACE_INFO(0x35bc, 0x0102, 0xff, 0xff, 0xff), .driver_info = RTL8852C}, /* TP-Link Archer TXE70UH (RTW8852CU) */
	{}	/* Terminating entry */
};
